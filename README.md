...
Системный промпт загружается из файла `system-prompt.md` и передается в каждый запрос к Claude API. Это позволяет задать контекст и поведение бота для обработки запросов о услугах автосервиса.
...
```json
{
  "model": "glm-4.5-air",
  "max_tokens": 1024,
  "system": "Содержимое системного промпта...",
  "messages": [
